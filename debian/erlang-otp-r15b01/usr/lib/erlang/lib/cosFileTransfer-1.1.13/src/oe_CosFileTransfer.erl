...
oe_dependency() ->
    ...
    {"/usr/local/src/erlang-otp-r15b01-0.1+imvu/lib/cosFileTransfer/src/CosFileTransfer.idl",
     ["/usr/local/src/erlang-otp-r15b01-0.1+imvu/lib/cosProperty/src/CosProperty.idl"]}.
