...
HCC = $(CC)
CC32 = gcc
CFLAGS32 = -g -O0 -I/usr/local/src/erlang-otp-r15b01-0.1+imvu/erts/x86_64-pc-linux-gnu   -fno-tree-copyrename -g -O0 -D_GNU_SOURCE -m32
BASIC_CFLAGS = -g -O0 -I/usr/local/src/erlang-otp-r15b01-0.1+imvu/erts/x86_64-pc-linux-gnu   -fno-tree-copyrename -g -O0 -D_GNU_SOURCE
DEBUG_FLAGS =  -g
LD = $(CC)
RANLIB = ranlib
AR = ar
...
#
XSLTPROC = xsltproc
FOP = /usr/local/src/erlang-otp-r15b01-0.1+imvu/make/fakefop
