...
#define ERTS_EMU_CMDLINE_FLAGS " -O2 -g -I/usr/local/src/otp_src_R15B01/erts/x86_64-unknown-linux-gnu   -fno-tree-copyrename -O2 -g -D_GNU_SOURCE -g -O2 -g -D_GNU_SOURCE -I/usr/local/src/otp_src_R15B01/erts/x86_64-unknown-linux-gnu    -DUSE_THREADS -D_THREAD_SAFE -D_REENTRANT -DPOSIX_THREADS -D_POSIX_THREAD_SAFE_FUNCTIONS  -Wall -Wstrict-prototypes -Wmissing-prototypes -Wdeclaration-after-statement"
