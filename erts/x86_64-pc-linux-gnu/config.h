...
#define ERTS_EMU_CMDLINE_FLAGS " -g -O0 -I/usr/local/src/erlang-otp-r15b01-0.1+imvu/erts/x86_64-pc-linux-gnu   -fno-tree-copyrename -g -O0 -D_GNU_SOURCE -g -g -O0 -D_GNU_SOURCE -I/usr/local/src/erlang-otp-r15b01-0.1+imvu/erts/x86_64-pc-linux-gnu    -DUSE_THREADS -D_THREAD_SAFE -D_REENTRANT -DPOSIX_THREADS -D_POSIX_THREAD_SAFE_FUNCTIONS  -Wall -Wstrict-prototypes -Wmissing-prototypes -Wdeclaration-after-statement"
